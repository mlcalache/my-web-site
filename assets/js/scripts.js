...
jQuery(document).ready(function () {
    ...
    */
    ...
    $('.personal-skills').backstretch("assets/img/backgrounds/personal-skills.jpg");
    $('.certifications').backstretch("assets/img/backgrounds/certifications.jpg");
    $('.initiatives').backstretch("assets/img/backgrounds/initiatives.jpg");
    // $('.technologies-container').backstretch("assets/img/backgrounds/1.jpg");
